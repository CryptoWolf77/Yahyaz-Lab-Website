...
export const studio = {
  ...
  logoTransparent: asset("brand/logo-transparent.png"),
  logoSquare: asset("brand/logo-square.png"),
...
export const games: Game[] = [
  {
    ...
    theme: "ninja",
    icon: asset("white-ninja/icon.png"),
    featured: asset("white-ninja/screen-2.png"),
    trailer: asset("videos/white-ninja-promo.mp4"),
    poster: asset("white-ninja/screen-2.png"),
    screenshots: [
      asset("white-ninja/screen-1.png"),
      asset("white-ninja/screen-2.png"),
      asset("white-ninja/screen-3.png"),
      asset("white-ninja/screen-4.png"),
      asset("white-ninja/screen-5.png"),
      asset("white-ninja/screen-6.png"),
      asset("white-ninja/screen-7.png"),
    ],
  ...
  },
  {
    ...
    theme: "zombie",
    featured: asset("puzzle-vs-zombie/featured.png"),
    trailer: asset("videos/puzzle-vs-zombie-promo.mp4"),
    poster: asset("puzzle-vs-zombie/featured.png"),
    screenshots: [
      asset("puzzle-vs-zombie/screen-1.png"),
      asset("puzzle-vs-zombie/screen-2.png"),
      asset("puzzle-vs-zombie/screen-3.png"),
      asset("puzzle-vs-zombie/screen-4.png"),
      asset("puzzle-vs-zombie/screen-5.png"),
      asset("puzzle-vs-zombie/screen-6.png"),
      asset("puzzle-vs-zombie/feature-graphics.jpg"),
    ],
